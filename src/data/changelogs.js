const changelogs = [
    {
        ...
        changes: [
            {
                type: 'changed',
                text: '行動版導覽重構：全站行動版介面（選單、控制中心、分類層）全面升級為高效能「底部抽屜 (Bottom Sheet)」，實現流暢的原生級操作體驗。'
            },
            {
                type: 'changed',
                text: '選單視覺升級：將手機版導覽項目重新編排為對稱的 2x2 網格佈局，採用橫向圖文設計，使點擊區域更直覺舒適。'
            },
            {
                type: 'fixed',
                text: '效能與圖層修復：移除手機端造成卡頓的高耗能模糊濾鏡並採用硬體加速動畫，同時徹底解決選單與音樂膠囊的圖層重疊問題。'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        changes: [
            {
                type: 'added',
                text: '風格游標：實作原生 CSS 圓潤游標系統，支援主題自動切換 (Dark/Light) 與圖片縮放/文字輸入樣式，並提供開關設定。'
            },
            {
                type: 'fixed',
                text: '穩定性修復：解決文章目錄 (TOC) 有時不顯示的競態問題，及修復渲染無限迴圈與建置錯誤。'
            }
        ]
    },
    {
        ...
        changes: [
            {
                type: 'added',
                text: '行動版體驗升級：重構手機版漢堡選單為底部抽屜 (Bottom Sheet)，並實作控制中心原點展開動畫與單卡片介面。'
            },
            {
                type: 'changed',
                text: '分類頁面優化：手機版改為緊湊 3 欄佈局，按鈕動畫升級為飽和度增強與內縮，互動更流暢。'
            },
            {
                type: 'added',
                text: '評論導航：控制中心「最近評論」支援深度連結，點擊後自動滾動至目標留言並高亮顯示。'
            },
            {
                type: 'changed',
                text: '視覺拋光：優化導覽列圖示，修正遮罩透明度，並移除手機版冗餘的設定文字。'
            }
        ]
    },
    {
