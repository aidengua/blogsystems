...
const LineCard = () => {
    ...
    return (
        ...
        >
            ...
            <div className="relative w-full h-full bg-[#1e1e1e] rounded-xl shadow-xl border border-gray-800 overflow-hidden">
                    ...
                    <div className={`absolute inset-0 backface-hidden p-4 overflow-hidden z-10 ${isAnimating ? 'animate-blur-fast' : ''}`}>
                        ...
                        <div className="relative z-10 flex items-center justify-between text-white h-full">
                            <div className="flex flex-col">
                                <span className="text-xs text-gray-400 mb-1">官方帳號 Line</span>
                        ...
                        <i className="fas fa-comment-dots absolute -right-4 -bottom-4 text-white/5 text-[5rem] blur-[2px]"></i>
                    </div>

                    {/* Back Face (QR Code) */}
                    <div
                        className={`absolute inset-0 backface-hidden bg-[#111] flex items-center justify-between px-6 z-10 ${isAnimating ? 'animate-blur-fast' : ''}`}
