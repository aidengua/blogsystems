...
const ClockWidget = () => {
    ...
    return (
        <div className="relative w-28 h-28 md:w-32 md:h-32 bg-black/20 backdrop-blur-xl border border-white/10 rounded-[1.5rem] shadow-xl flex items-center justify-center overflow-hidden group hover:bg-black/30 transition-all duration-300">
            {/* Clock Face */}
