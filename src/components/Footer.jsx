const Footer = () => {
    return (
        <footer className="bg-[#1e1e1e] border-t border-white/5 py-6 mt-12">
            <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex flex-col items-start gap-2">
                    <div className="flex items-center gap-2 text-sm text-gray-400">
                        ...
                        />
                        <span className="font-bold text-white hover:text-[#709CEF] transition-colors cursor-pointer">呂宥德</span>
                    </div>
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-gray-500">
                        ...
                        <span className="hover:text-gray-300 transition-colors cursor-pointer">架構透過NextJs導入</span>
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="flex items-center gap-2 text-lg text-gray-400">
                        <i className="fab fa-creative-commons hover:text-white transition-colors cursor-pointer"></i>
                        <i className="fab fa-creative-commons-by hover:text-white transition-colors cursor-pointer"></i>
                        <i className="fab fa-creative-commons-nc hover:text-white transition-colors cursor-pointer"></i>
                        <i className="fab fa-creative-commons-nd hover:text-white transition-colors cursor-pointer"></i>
                    </div>
                </div>
            </div>
        </footer>
